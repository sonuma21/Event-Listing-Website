...
<head>
    ...
    <title>Payment Request Notification</title>
...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white max-w-lg w-full rounded-lg shadow-lg p-6">
            <h1 class="text-2xl font-semibold text-gray-800 mb-4">New Payment Request</h1>
            <p class="text-gray-600 mb-6">
                Dear Admin, you have a new payment request from
